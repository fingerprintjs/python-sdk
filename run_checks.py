...
from fingerprint_server_sdk import Configuration, FingerprintApi
...
def main() -> int:
    ...
    try:
        ...
        search_events_response_second_page = api.search_events(
            2, start=start, end=end, pagination_key=search_events_response.pagination_key
        )
        ...
        print(f'Exception when calling FingerprintApi.search_events: {e}\n', file=sys.stderr)
        return 1
    ...
    try:
        ...
        print(f'Exception when trying to read old data: {e}\n', file=sys.stderr)
        return 1
