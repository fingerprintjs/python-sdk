...
from fingerprint_server_sdk import Configuration, __version__, Event, EventSearch, EventUpdate, BadRequestException, \
    ErrorResponse, ErrorCode, ForbiddenException, NotFoundException, TooManyRequestsException, ConflictException
...
class TestFingerprintApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.integration_info = ('ii', 'fingerprint-server-python-sdk/%s' % __version__)
        self.request_headers = {
            'Content-Type': 'application/json',
            'Authorization': f'Bearer {API_KEY}',
            'Accept': 'application/json',
            'User-Agent': 'fingerprint-server-python-sdk/%s' % __version__
        }
    ...
    def get_event_path(event_id, region: Region = Region.US):
        ...
        return '%s/events/%s' % (base, event_id)
    ...
    def delete_visitor_path(visitor_id, region: Region = Region.US):
        base = Configuration.get_host(region)
        return '%s/visitors/%s' % (base, visitor_id)
    ...
    def test_delete_visitor_data(self) -> None:
        ...
        mock_pool.expect_request('DELETE', TestFingerprintApi.delete_visitor_path(visitor_id),
                                 body=None, response_text="{}", headers=self.request_headers,
    ...
    def test_delete_visitor_data_bad_request(self) -> None:
        ...
        mock_pool.expect_request('DELETE',TestFingerprintApi.delete_visitor_path(visitor_id), body=None, headers=self.request_headers, preload_content=True, timeout=None, response_status_code=400, response_data_file="errors/400_visitor_id_invalid.json")
    ...
    def test_delete_visitor_data_forbidden(self) -> None:
        ...
        self.api.api_client.rest_client.pool_manager = mock_pool
        visitor_id = "XXXXXXXXXXXXXXXXXXXX"
        mock_pool.expect_request('DELETE', TestFingerprintApi.delete_visitor_path(visitor_id), body=None,
                                 headers=self.request_headers, preload_content=True, timeout=None,
                                 response_status_code=403, response_data_file="errors/403_feature_not_enabled.json")
    ...
    def test_delete_visitor_data_not_found(self) -> None:
        ...
        mock_pool.expect_request('DELETE', TestFingerprintApi.delete_visitor_path(visitor_id), body=None,
                                 headers=self.request_headers, preload_content=True, timeout=None,
                                 response_status_code=404, response_data_file="errors/404_visitor_not_found.json")
    ...
    def test_delete_visitor_data_too_many_requests(self) -> None:
        ...
        mock_pool.expect_request('DELETE', TestFingerprintApi.delete_visitor_path(visitor_id), body=None,
                                 headers=self.request_headers, preload_content=True, timeout=None,
                                 response_status_code=429, response_data_file="errors/429_too_many_requests.json", response_headers={'Retry-After': '5'})
    ...
    def test_get_event(self) -> None:
        ...
        mock_pool.expect_request('GET', TestFingerprintApi.get_event_path(event_id),
                                 fields=[], headers=self.request_headers,
                                 preload_content=True, timeout=None, response_data_file="events/get_event_200.json")
    ...
    def test_get_event_bad_request(self) -> None:
        ...
        mock_pool.expect_request('GET', TestFingerprintApi.get_event_path(event_id),
                                 fields=[], headers=self.request_headers,
                                 preload_content=True, timeout=None,
                                 response_status_code=400, response_data_file="errors/400_event_id_invalid.json")
    ...
    def test_get_event_forbidden(self) -> None:
        ...
        mock_pool.expect_request('GET', TestFingerprintApi.get_event_path(event_id),
                                 fields=[], headers=self.request_headers,
                                 preload_content=True, timeout=None,
                                 response_status_code=403, response_data_file="errors/403_secret_api_key_required.json")
    ...
    def test_get_event_not_found(self) -> None:
        ...
        mock_pool.expect_request('GET', TestFingerprintApi.get_event_path(event_id),
                                 fields=[], headers=self.request_headers,
                                 preload_content=True, timeout=None,
                                 response_status_code=404, response_data_file="errors/404_event_not_found.json")
    ...
    def test_get_event_too_many_requests(self) -> None:
        ...
        mock_pool.expect_request('GET', TestFingerprintApi.get_event_path(event_id),
                                 fields=[], headers=self.request_headers,
                                 preload_content=True, timeout=None,
                                 response_status_code=429, response_data_file="errors/429_too_many_requests.json")
    ...
    def test_search_events(self) -> None:
        ...
        mock_pool = MockPoolManager(self)
        self.api.api_client.rest_client.pool_manager = mock_pool
        mock_pool.expect_request('GET', TestFingerprintApi.get_search_events_path(params),
                                 fields=[], headers=self.request_headers,
                                 preload_content=True, timeout=None, response_data_file="events/search/get_event_search_200.json")
    ...
    def test_search_events_bad_request(self) -> None:
        ...
        mock_pool.expect_request('GET', TestFingerprintApi.get_search_events_path(params),
                                 fields=[], headers=self.request_headers,
                                 preload_content=True, timeout=None,
                                 response_status_code=400, response_data_file="errors/400_request_body_invalid.json")
    ...
    def test_update_event(self) -> None:
        ...
        for (update_body, serialized_body) in test_cases:
            mock_pool.expect_request('PATCH',
                                     TestFingerprintApi.get_event_path(event_id),
                                     headers=self.request_headers, preload_content=True, timeout=None,
                                     body=serialized_body, response_text="OK")
    ...
    def test_update_event_bad_request(self) -> None:
        ...
        mock_pool.expect_request('PATCH', TestFingerprintApi.get_event_path(event_id),
                                 headers=self.request_headers, preload_content=True, timeout=None,
                                 body='{"linkedId": "test"}',
                                 response_status_code=400, response_data_file="errors/400_request_body_invalid.json")
    ...
    def test_update_event_conflict(self) -> None:
        ...
        mock_pool.expect_request('PATCH', TestFingerprintApi.get_event_path(event_id),
                                 headers=self.request_headers, preload_content=True, timeout=None,
                                 body='{"suspect": true}',
                                 response_status_code=409, response_data_file="errors/409_state_not_ready.json")
