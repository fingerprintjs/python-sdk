...
class RawDeviceAttributes(BaseModel):
    ...
    device_memory: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Rounded amount of RAM (in gigabytes) reported by the browser.")
    timezone: Optional[StrictStr] = Field(default=None, description="Timezone identifier detected on the client.")
    canvas: Optional[Canvas] = None
    languages: Optional[List[List[StrictStr]]] = Field(default=None, description="Navigator languages reported by the agent including fallbacks. Each inner array represents ordered language preferences reported by different APIs. ")
    webgl_extensions: Optional[WebGlExtensions] = None
    webgl_basics: Optional[WebGlBasics] = None
    screen_resolution: Optional[Annotated[List[StrictInt], Field(min_length=2, max_length=2)]] = Field(default=None, description="Current screen resolution.")
    ...
    hardware_concurrency: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Number of logical CPU cores reported by the browser.")
