...
class EventEdge(BaseModel):
    ...
    source: Literal['edge'] = Field(
        description='Identifies how the event was generated. Always `edge` for events generated by the Automation Intelligence API (`/edge` endpoint).'
    )
