...
class TriggeredByInner(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TriggeredByInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TriggeredByInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {'id': obj.get('id'), 'name': obj.get('name'), 'description': obj.get('description')}
        )
