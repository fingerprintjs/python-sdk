...
from fingerprint_server_sdk import rest
from fingerprint_server_sdk.rest import ApiException, RESTResponse
    ...
    def __init__(self, configuration: Optional[Configuration] = None, header_name: Optional[str] = None,
        ...
        if pool is None:
            try:
                ...
                from fingerprint_server_sdk.dummy_pool import DummyPool
                self.pool = DummyPool()
        else:
            self.pool = pool
