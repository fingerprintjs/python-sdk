...
- Update Server API schema to `v3.7.1`:
  ...
  - Clarify `ProxyDetails.proxy_type` and other signal descriptions to match the updated API v3 documentation. ([5888327](https://github.com/fingerprintjs/python-sdk/commit/5888327f32ee2910996779acc10903a089ce7acb))
...
- ### SDK Changes ([8b3971e](https://github.com/fingerprintjs/python-sdk/commit/8b3971eb8a30c2d5bd52f9b188b0c2731a096d43))
  ...
  :warning: `fingerprint_pro_server_api_sdk` uses Server API v3, which is deprecated. Please migrate to the new [`fingerprint_server_sdk`](https://github.com/fingerprintjs/python-sdk) package which uses Server API v4. ([8b3971e](https://github.com/fingerprintjs/python-sdk/commit/8b3971eb8a30c2d5bd52f9b188b0c2731a096d43))
